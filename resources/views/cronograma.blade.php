            ...
            <div class="col-md-6 offset-md-3">
                <table class="table table-striped" style="font-size: 11px">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">{{ number_format($v/$pe,2,'.',',')}}</td>
                        <td style="text-align: right">{{ number_format($Ti/$pe,2,'.',',')}}</td>
                        <td style="text-align: right">{{ number_format($m/$pe,2,'.',',')}}</td>
                    </tr>
                    @endfor
                   
                    <tr>
                        <td colspan="2" style="text-align: right"><b>Total</b></td>
                        <td style="text-align: right"><b>{{ number_format($v,2,'.',',')}}</b></td>
                        <td style="text-align: right"><b>{{ number_format($Ti,2,'.',',')}}</b></td>
                        <td style="text-align: right"><b>{{ number_format($m,2,'.',',')}}</b></td>
                    </tr>
                </table>    
            </div>
        </div>
